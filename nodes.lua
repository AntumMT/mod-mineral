...
local nodes = {
	{
		...
		tiles       = {mineral.ore_underlay .. "^mineral_overlay_coal.png"},
		groups      = {cracky = 3},
	...
	},
	{
		...
		tiles       = {mineral.ore_underlay .. "^mineral_overlay_copper.png"},
		groups      = {cracky = 2},
	...
	},
	{
		...
		tiles       = {mineral.ore_underlay .. "^mineral_overlay_diamond.png"},
		groups      = {cracky = 1},
	...
	},
	{
		...
		tiles       = {mineral.ore_underlay .. "^mineral_overlay_gold.png"},
		groups      = {cracky = 2},
	...
	},
	{
		...
		tiles       = {mineral.ore_underlay .. "^mineral_overlay_iron.png"},
		groups      = {cracky = 2},
	...
	},
	{
		...
		tiles       = {mineral.ore_underlay .. "^mineral_overlay_tin.png"},
		groups      = {cracky = 2},
